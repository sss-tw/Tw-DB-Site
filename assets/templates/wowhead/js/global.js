        ...
        for (var X = 0, e = V.length; X < e; ++X) {
            if (V[X][0] == null) {
                ...
                if (V[X][5] != null) {
                    ...
                    F.style.backgroundImage = "url(./assets/images/icons/small/" + V[X][5] + ".png)";
                    if (V[X].checked) {
                        var K = ce("span");
...
var Icon = {
    ...
    create: function (A, J, I, D, B, H) {
        ...
        if (A != null) {
            E.style.backgroundImage = "url(./assets/images/icons/" + Icon.sizes[J] + "/" + A.toLowerCase() + ".png)"
        }
        C.className = "tile";
        if (I || D) {
            var F = ce("a");
...
var Tooltip = {
    ...
    setIcon: function (A) {
        Tooltip.prepare();
        if (A) {
            Tooltip.icon.style.backgroundImage = "url(./assets/images/icons/medium/" + A.toLowerCase() + ".png)";
...
Listview.funcBox = {
    ...
    coEditAppend: function (L, C, K) {
        ...
        for (var Q = 0, R = S.length; Q < R; ++Q) {
            ...
            X.src = "../../assets/templates/wowhead/images/pixel.gif";
    ...
    appendMoney: function (E, A, F, J, K, B) {
        ...
        if (B != null) {
            for (var C = 0; C < B.length; ++C) {
                ...
                I.style.backgroundImage = "url(./assets/images/icons/small/" + g_items.getIcon(G).toLowerCase() + ".png)";
                ae(I, ct(D));
                ae(E, I)
            }
        }
    ...
    function display(textbox, search, suggz, dataz) {
        ...
        for (var i = 0, len = suggz.length; i < len; ++i) {
            ...
            if ((type == 3 || type == 6) && param1) {
                ...
                div.style.backgroundImage = "url(./assets/images/icons/small/" + param1.toLowerCase() + ".png)"
            } else {
